...
import com.rafaelximenes.cursomc.domain.PagamentoComCartao;
...
import com.rafaelximenes.cursomc.repositories.CidadeRepository;
...
import com.rafaelximenes.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p4 = new Produto(null, "Mesa de Escritória", 300.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rafaximenes1@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bp.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "ANA Silva", "rafa.ximenes1@gmail.com", "04208920360", TipoCliente.PESSOAFISICA, bp.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Matos3", "105", "Sala 800", "Centro", "38777012", cli1, c3);
